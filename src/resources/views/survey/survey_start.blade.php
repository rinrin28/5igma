    ...
    <body class="font-mono">
        <div class="flex min-h-screen flex-col">
            <div class="flex flex-col flex-1"> 
                <header class="header w-full h-[70px] bg-customGray flex items-center px-6 rounded-br-3xl rounded-bl-3xl mb-6">
                    <div class="container flex items-center justify-between">
                        <h1 class="text-2xl font-bold text-customPink">職場環境改善アンケート</h1>
                        
                        <div class="job flex items-center space-x-2 text-customNavy">
                ...
                <main class="flex-1 flex items-center justify-center bg-customGray shadow-inner rounded-3xl p-4">
                    <div class="bg-white mx-auto rounded-3xl shadow-md p-10 flex justify-between items-center main-container">
                        <!-- 左側：ロゴとタイトル -->
                        <div class="logo flex flex-col items-center space-y-4 logo-section ml-36">
                            <img src="{{ asset('image/BB_large.png') }}" alt="BizBuddy Logo" class="w-80 h-80 rounded-full shadow-lg mb-8" />
                            <h1 class="text1 text-5xl font-semibold text-customNavy">BizBuddy</h1>
                        </div>

                        <!-- 右側：アンケート情報 -->
                        <div class="survey-info mr-32">
                            <h2 class="text2 text-customLightPink text-3xl font-bold mb-6">職場環境改善アンケート</h2>
                            ...
                            <ul class="space-y-4 text-customNavy text-lg">
                                ...
                                <li class="flex items-center period">
                            ...
                            <div class="mt-2 space-y-3">
                                <form id="survey-form" method="POST">
                                    @csrf
                                    <button type="button" id="start-survey" class="button1 w-3/4 mx-auto block bg-customPink text-white text-lg py-3 rounded-xl shadow-md hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed" disabled>
                                        アンケートを開始
                                    </button>
                                    <p class="text-center text-sm text-[#82868B]">または</p>
                                    <button type="button" id="resume-survey" class="button2 w-3/5 bg-customLightPink text-white text-lg py-3 rounded-xl shadow-md hover:opacity-90 mx-auto block">
                                        アンケートを再開
                                    </button>
                                </form>
                            </div>
