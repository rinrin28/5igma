...
<body class="font-mono bg-gradient-to-b from-[#F5F6F8] to-white min-h-screen">
    ...
    <main class="min-h-screen flex items-center justify-center pt-[60px]">
        ...
        <div class="relative text-center fade-in bg-white/80 backdrop-blur-md rounded-[40px] shadow-xl p-24 mx-auto w-[800px]">
            <!-- BizBuddyロゴ -->
            <div class="relative w-60 h-60 mx-auto mb-16">
                <img src="{{ asset('image/BB_large.png') }}" alt="BizBuddy" class="w-full h-full object-contain logo-spin drop-shadow-lg">
            </div>

            <!-- BizBuddy テキスト -->
            <h2 class="text-5xl font-bold text-customNavy mb-16 tracking-wide pulse">BizBuddy</h2>

            <!-- 完了メッセージ -->
            <div class="space-y-8">
                <p class="text-3xl font-bold text-customPink">アンケートは完了です</p>
                <p class="text-xl text-customNavy">ご協力ありがとうございました</p>
            </div>
        </div>
    </main>
</body>
